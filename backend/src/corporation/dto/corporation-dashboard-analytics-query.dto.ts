...
/** Optional scope and time window for Corporation Admin dashboard analytics. */
export class CorporationDashboardAnalyticsQueryDto {
  @ApiPropertyOptional({
    description:
      'Scope companies and users to a single company under the caller corporation. Omit for all companies in the corporation.',
